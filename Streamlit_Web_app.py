...
This app predicts the **Diabetes** of the patient!
''')
st.sidebar.write(''' 
# **Patient Data**
Adjust the values to see the prediction''')
...
def user_report():
    ...
    bmi = st.sidebar.slider('BMI',13,40,17)
...
fig_preg = plt.figure()
ax1= sns.scatterplot(x = 'Age', y = 'Pregnancies', data=df, hue = 'Outcome', palette = 'YlOrRd')
...
ax1= sns.scatterplot(x = 'BMI', y = 'Pregnancies', data=df, hue = 'Outcome', palette = 'Reds')
